...
Constraint P_BanType PRIMARY KEY(Id),
)

insert into Ban(Reason,BanDuration) values('Uygunsuz Mesajlaşma',200)
insert into Ban(Reason,BanDuration) values('Uygunsuz Mesajlaşma 2',400)
insert into Ban(Reason,BanDuration) values('Uygunsuz Mesajlaşma 3',1600)
...
ProfileImage nvarchar(250) not null,
...
UserPassword,UserTypeId,TotalActiveteMinutes,ProfileImage,IsPassive,IsDelete,IsBanned) 
values('Server','ÇETİN','admin','merhaba@servercetin.com','1993/01/07',1,'202cb962ac59075b964b07152d234b70',1,0,'eklenecek',0,0,0)
...
insert into Mastery(UserId,CategoryWins,CategoryMatchingCount,LastMatch,LastOwnedDate,Rates,CategoryId,IsPassive,IsDelete) 
values(1,13,23,'2019-12-22 14:28:07.180','2019-12-22 14:28:07.130',1.4,1,0,0)
insert into Mastery(UserId,CategoryWins,CategoryMatchingCount,LastMatch,LastOwnedDate,Rates,CategoryId,IsPassive,IsDelete) 
values(1,13,23,'2019-12-22 14:28:07.180','2019-12-22 14:28:07.130',1.4,2,0,0)
...
insert into UserHobies(UserId,HobbyId) values(1,1)
insert into UserHobies(UserId,HobbyId) values(1,2)
insert into UserHobies(UserId,HobbyId) values(1,3)
...
Id int Identity(1,1) not null,
SenderId int not null,
ChatMessageText nvarchar(50) not null,
ChatId int not null,
...
insert into UserRosette(UserId,RosetteId,OwnedDate,IsPassive,IsDelete) values
(1,1,'2019-12-22 14:28:07.180',0,0)
insert into UserRosette(UserId,RosetteId,OwnedDate,IsPassive,IsDelete) values
(1,2,'2019-12-22 14:28:07.180',0,0)
...
CONSTRAINT F_UserBan2 FOREIGN KEY(BanTypeId) REFERENCES BanType(Id),
)
...
CONSTRAINT F_Document FOREIGN KEY(SenderId) REFERENCES TartIshUser(Id),
)
